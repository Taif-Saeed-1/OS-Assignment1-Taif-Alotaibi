...
class Process implements Runnable {
    ...
    // Feature 1: process priority (1-5, where 5 is highest)
    ...
    // Feature 1: getter for process priority
...
public class SchedulerSimulation {
    // Feature 2: count total context switches during the simulation
    static int contextSwitchCount = 0;

    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445052186; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        System.out.println(Colors.BOLD + Colors.BRIGHT_GREEN +
                "╚════════════════════════════════════════════════════════════════════════════════╝" +
                Colors.RESET + "\n");
        System.out.println("Total context switches: " + contextSwitchCount);// features• Diffusion
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        // Feature 1: Display priority when entering queue
